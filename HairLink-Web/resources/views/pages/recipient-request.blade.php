...
<div class="section-wrap recipient-request-page">
    ...
    <form id="request-form" class="request-form">
        ...
        <div class="form-section">
            <div class="section-header">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor" class="section-icon">
                    <path d="M3 13h2v8H3zm4-8h2v16H7zm4-2h2v18h-2zm4-2h2v20h-2zm4 4h2v16h-2zm4 8h2v8h-2z" opacity="0.3"></path>
            ...
            <div class="form-group">
                ...
                <p class="help-text">E.g. picture of medical certificate, doctor's diagnosis, or any proof that verifies the donee as a patient</p>
                <div class="file-upload">
                    <input type="file" id="documents" name="documents" multiple accept=".pdf,.jpg,.jpeg,.png,.doc,.docx" required>
            ...
            <div class="form-group">
                ...
                <p class="help-text">You may upload photos of the patient to help us gain a clearer understanding of their condition.</p>
                <div class="file-upload">
                    <input type="file" id="additional-photo" name="additionalPhoto" accept=".jpg,.jpeg,.png,.gif,.webp" required>
