        ...
        <div class="form-section">
            ...
            <div class="billing-body">
                ...
                <div class="billing-fields">
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            <label for="amount-number">Amount of Donation (in number) <span class="required">*</span></label>
                            <input type="text" id="amount-number" name="amountNumber" placeholder="Ex. 10,000.00" required>
                        </div>
                        <div class="form-group">
                            <label for="amount-words">Amount of Donation (in words) <span class="required">*</span></label>
                            <input type="text" id="amount-words" name="amountWords" placeholder="Ex. Ten thousand pesos" required>
                        </div>
                    </div>
