    ...
    <section class="section-wrap profile-shell reveal" data-profile-page data-profile-type="donor">
        ...
        <article class="profile-card">
            ...
            <div class="profile-actions">
                <button class="soft-btn" type="button" onclick="document.getElementById('editProfileModal').classList.remove('hidden')">
            ...
            <div class="profile-grid">
                ...
                <div class="profile-item">
                    ...
                    <strong id="displayPhone">{{ $user->phone ?? 'Not set' }}</strong>
                </div>
                <div class="profile-item">
                    <small>Age</small>
                    <strong id="displayAge">{{ $user->age ?? 'Not set' }}</strong>
                </div>
                <div class="profile-item">
                    <small>Gender</small>
                    <strong id="displayGender">{{ ucfirst($user->gender ?? 'Not set') }}</strong>
                </div>
                <div class="profile-item" style="grid-column: span 2;">
                    <small>Short Bio</small>
                    <strong id="displayBio" style="font-style: italic; font-weight: 500;">
        ...
        <article class="referral-code-card">
            <div class="referral-code-head">
                ...
                <div>
                    ...
                    <p>Share to earn 5 points per donor</p>
                </div>
            </div>
        ...
        <article class="profile-stats">
            ...
            <div class="profile-stat">
                ...
                <strong>Visit the Community page to see how your donation helps others!</strong>
            </div>
        </article>
...
@push('scripts')
    <script>
        // Simple JS to toggle modal since we used inline styles for reliability
        document.querySelector('[onclick*="remove(\'hidden\')"]').onclick = function() {
