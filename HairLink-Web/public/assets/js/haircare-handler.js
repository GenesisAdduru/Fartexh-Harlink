...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function renderArticles() {
        const articles = HairCareModule.getArticles();
    ...
    function showArticleDetail(articleId) {
        const article = HairCareModule.getArticle(articleId);
    ...
    function renderVideos() {
        const videos = HairCareModule.getVideos();
    ...
    function showVideoPlayer(videoId) {
        const video = HairCareModule.getVideo(videoId);
