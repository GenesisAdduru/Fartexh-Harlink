// Donor Community Page Handler

document.addEventListener('DOMContentLoaded', () => {
    // Note: We'll use the server-side Auth data where possible, 
    // but the JS currently expects these variables.
    const currentUserElement = document.getElementById('greetingText');
    const userName = currentUserElement ? currentUserElement.dataset.name : 'Donor';
